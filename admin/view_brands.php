                ...
                while($row = mysqli_fetch_assoc($catQueryResult))
                {
                    ...
                    echo "<div class=\"row\">
                                    <div class=\"col col-4\" style='margin-bottom: 2%; margin-top: 2%;'>
                                     ...
                                     <div class=\"col col-4\" style='margin-bottom: 2%; margin-top: 2%;'>
                                        <a href=\"index.php?edit_brand = $brand_id\" class=\"btn btn-danger\"style=' width: 100%;background-color: #45a049;color: white;padding: 12px 20px;border: none;border-radius: 10px;cursor: pointer;'>
